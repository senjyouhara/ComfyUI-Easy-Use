...
New Front-end of [ComfyUI-Easy-Use](https://github.com/senjyouhara/ComfyUI-Easy-Use) custom nodes. This repo will replace the original web_extension in future releases.
...
git clone https://github.com/senjyouhara/ComfyUI-Easy-Use-Frontend
```
